...
const DeleteProjectCategoryModal = ({
  isOpen,
  onClose,
  ...
  const handleDelete = async () => {
    if (!projectCategory || !projectCategory.id) {
    ...
    try {
      await projectCategoriesApi.deleteProjectCategory(projectCategory.id)
  ...
  if (!isOpen || !projectCategory) return null

  const categoryName = projectCategory.name || 'this category'
  const projectsCount = projectCategory.projectsCount || projectCategory.projects_count || 0
      ...
      >
        ...
        <div className="px-6 py-6">
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            Are you sure you want to delete <span className="font-semibold text-gray-900 dark:text-white">"{categoryName}"</span>? This action cannot be undone.
          </p>
            ...
            <div className="bg-yellow-50 dark:bg-yellow-900/10 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4 mb-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-yellow-800 dark:text-yellow-300">
                  This category has <strong>{projectsCount}</strong> associated project{projectsCount !== 1 ? 's' : ''}. You must reassign or delete these projects before deleting the category.
                </p>
              </div>
            </div>
          )}
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900/10 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-yellow-800 dark:text-yellow-300">
                This will permanently remove the category from your system. All associated data will be lost.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-end gap-3 border-t border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-[#152721] px-6 py-4">
          ...
          <button
            ...
            disabled={isDeleting || projectsCount > 0}
...
export default DeleteProjectCategoryModal
