...
const TeamPagination = ({
  ...
  return (
    <div className={`bg-white dark:bg-card-dark rounded-xl shadow-soft px-6 py-4 border border-gray-100 dark:border-gray-700 flex flex-col sm:flex-row items-center justify-between gap-4 ${className}`}>
      <span className="text-sm text-gray-500 dark:text-gray-400 text-center sm:text-left">
        ...
        <span className="font-semibold text-gray-900 dark:text-white">{totalItems}</span> Staff Members
      </span>
