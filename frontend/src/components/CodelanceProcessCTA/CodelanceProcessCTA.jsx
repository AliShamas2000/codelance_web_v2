...
const CodelanceProcessCTA = ({
  ...
  return (
    <section 
      ref={ref}
      className={`max-w-[1400px] mx-auto px-6 lg:px-12 lg:py-24 pb-10 transition-all duration-1000 ease-out ${
        isVisible 
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
            {primaryButtonText && (
              <button
                ...
                className="group relative bg-primary text-white text-base font-bold px-10 py-4 rounded-xl overflow-hidden transition-all shadow-xl shadow-primary/30 active:scale-[0.98] whitespace-nowrap"
              >
