...
const DeleteReviewModal = ({
  ...
  const handleDelete = async () => {
    if (!review || !review.id) {
      setError('Review information is missing')
      return
    }
  ...
  const authorName = review.authorName || review.author_name || 'this review'
      ...
      >
        ...
        <div className="px-6 py-6">
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            Are you sure you want to delete the review from <span className="font-semibold text-gray-900 dark:text-white">"{authorName}"</span>? This action cannot be undone.
          </p>
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900/10 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-yellow-800 dark:text-yellow-300">
                This will permanently remove the review from your portfolio. All associated data and images will be deleted.
              </p>
            </div>
          </div>
        </div>
