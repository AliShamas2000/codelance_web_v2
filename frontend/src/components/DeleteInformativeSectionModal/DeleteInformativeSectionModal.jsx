...
const DeleteInformativeSectionModal = ({
  isOpen,
  onClose,
  section = null,
  onSuccess
  ...
  const handleDelete = async () => {
    if (!section || !section.id) {
      setError('Section information is missing')
      return
    }
    ...
    try {
      await informativeSectionsApi.deleteSection(section.id)
  ...
  const sectionTitle = section.title || section.titleEn || section.title_en || section.name || 'this section'
      ...
      >
        ...
        <div className="px-6 py-6">
          <p className="text-gray-700 dark:text-gray-300 mb-4">
            Are you sure you want to delete <span className="font-semibold text-gray-900 dark:text-white">"{sectionTitle}"</span>? This action cannot be undone.
          </p>
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900/10 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-yellow-800 dark:text-yellow-300">
                This will permanently remove the section from your website. This action cannot be reversed.
              </p>
            </div>
          </div>
        </div>
...
export default DeleteInformativeSectionModal
